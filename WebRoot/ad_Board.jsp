...
<html lang="en-us">
	...
	<header id="header" style="height:100px;">
			<div id="logo-group" style="width:100%;">
				...
				<label class="TitleLabel">板卡模块管理</label>
				<!-- END AJAX-DROPDOWN -->
			</div>
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark" style="font-family:'Microsoft YaHei';"><i class="fa fa-lg fa-fw fa-code-fork"></i> 板卡管理 </h1>
					</div>
				...
				<div>
				<a class="btn btn-success btn-lg" href="javascript:void(0);" style="margin-bottom: 1%;float:right" id="addBoard"><i class="fa fa-lg fa-fw fa-plus-circle"></i>添加板卡</a>
				<!-- row -->
					<div class="row">
							...
							<div class="jarviswidget jarviswidget-color-darken" data-widget-editbutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										<div class="widget-body-toolbar">
											<div>
												<select class='input-sm' id='search-type' style='font-size:14px'>
													...
													<option value="boardcardName">板卡名称</option>
													<option value="slotName">板卡卡槽</option>
												</select >
										...
										<table id="boardTable" class="table table-striped table-bordered table-hover"style="text-align:center">
											<thead class="thead-font">
												<tr>
													...
													<th>板卡插槽</th>
													<th>固定接口名称及其数量(个)</th>
													<th>可插拔插卡槽名称及其数量(个)</th>
													<th>备注</th>
													<th colspan="3" width="20%">编辑</th>
												</tr>
											</thead>
											<tbody id="Comptable" class="tbody-font">	
												<!--  <tr>
													<td>1</td>
												    <td>板卡1</td>
													<td>NM</td>
													<td>NM(3),SIC(4),HIM(5)</td>
													<td>aa(3),bb(4),cc(5)</td>
													<td>备注</td>
													<td>
			...
			<form  class="form-horizontal" style="width:70%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei';margin-top:20px">
				<div class="form-group">
					<label class="control-label col-md-4">板卡模块名称:</label>
					<div class=" col-md-8">
					<input name="boardName" value="" id="boardName" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-4">厂商名称:</label>
					<div class=" col-md-8">
					<input name="factoryName" value="" id="factoryName" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-4">板卡插槽:</label>
					<div class="col-md-5">
						<select name="boardPortName" value="" id="boardPortName" class="form-control">
						<option>NM</option>
						<option>AIM</option>
						<option>HIM</option>
						<option>MIM</option>
				...
				<!-- <div class="form-group">
					<label class="control-label col-md-4">固定接口数量:</label>
					<div class="col-md-8">
						<input name="boardNum" value="" id="boardNum" class="form-control">
					</div>
				</div>	 -->
				<!-- <div class="form-group">
					<label class="control-label col-md-4">固定接口列表:</label>
					<div class="col-md-5">
						<select name="boardFixList" value="" id="boardFixList" class="form-control" multiple="mutiple">
							<option>光口</option>
							<option>以台电口</option>
							<option>E1口</option>
						</select>
				    ...
				    <div class="col-md-3">
						<select name="boardFixListNum" value="" id="boardFixListNum" class="form-control" >
							<option>1个</option>
							<option>2个</option>
							<option>3个</option>
						</select>
				...
				<!-- <div class="form-group">
					<label class="control-label col-md-4">可插拔插槽数量:</label>
					<div class="col-md-8">
						<input type="text" name="boardSocketNum" id="boardSocketNum" class="form-control">
					</div>
				</div>	 -->
				<!--  <div class="form-group">
					<label class="control-label col-md-4">可插拔插槽列表:</label>
					<div class="col-md-5">
						<select name="boardSocketList" value="" id="boardSocketList" class="form-control" multiple="mutiple">
							<option>插槽1</option>
							<option>插槽2</option>
							<option>插槽3</option>
						</select>
					...
					<div class="col-md-3">
						<select name="boardSocketListNum" value="" id="boardSocketListNum" class="form-control">
							<option>1个</option>
							<option>2个</option>
							<option>3个</option>
						</select>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<textarea type="text" name="boardDes" id="boardDes" class="form-control">
						</textarea> 
					</div>
				</div>					
				<div class="form-group">
					...
					<div style="text-align:center">
						<button type="button" class="btn btn-success"  id="editSubmit">确定</button>
					</div> 
				</div>				
			</form>
		...
		<div  class="page2 dialog-message">
			<form  action="./servlet/UpLoadify" class="form-horizontal" style="width:70%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei';margin-top:20px">
				<div class="form-group">
					<label class="control-label col-md-4">板卡模块名称:</label>
					<div class=" col-md-8">
					<input name="newBoardName" value="" id="newBoardName" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-4">厂商名称:</label>
					<div class=" col-md-8">
					<input name="newFactoryName" value="" id="newFactoryName" class="form-control">
					</div>
				</div>
				<!-- <div class="form-group">
					<label class="control-label col-md-4">板卡编号:</label>
					<div class=" col-md-8">
					<input name="newBoardNum" value="" id="newBoardNum" class="form-control">
					</div>
				</div> -->
				<div class="form-group">
					<label class="control-label col-md-4">板卡插槽:</label>
					<div class="col-md-5">
						<select name="newInnerName" value="" id="newInnerName" class="form-control">
						<!--  <option>HM</option>
						<option>AIM</option>
						<option>HIM</option>
						<option>MIM</option>-->
				...
				<div class="form-group">
					<label class="control-label col-md-4">板卡图片:</label>
					<div class="col-md-8">
						<div id="imgdiv" style="height:32px;">
							<img id="imgShow" width="180" height="32" style="float:left"/>
						</div>
	    				<input type="file" name="file" size="50" id="up_img"/>
                     	<br />
				...
				<!-- <div class="form-group">
					<label class="control-label col-md-4">固定接口数量:</label>
					<div class="col-md-8">
						<input name="newFixBoardNum" value="" id="newFixBoardNum" class="form-control">
					</div>
				</div>	 -->
				<div class="form-group">
					<label class="control-label col-md-4">固定接口列表:</label>
					<div class="col-md-5">
						<select name="newFixBoardList" value="" id="newFixBoardList" class="form-control" multiple="mutiple">
						   <!--  <option value="1">FES</option>
							<option value="2">GES</option>
							<option value="3">FEP</option>
							<option value="4">GEP</option>
							<option value="5">CE1/PRI</option>
							<option value="6">CT1/PRI</option>
							<option value="7">Syn/Asyn Serial</option>-->
						</select>
					</div>
					<!--  <div class="col-md-3">
						<select name="newFixBoardListNum" value="" id="newFixBoardListNum" class="form-control" >
							<option>1个</option>
							<option>2个</option>
							<option>3个</option>
						</select>
				...
				<!-- <div class="form-group">
					<label class="control-label col-md-4">可插拔插槽数量:</label>
					<div class="col-md-8">
						<input type="text" name="newBoardSocketNum" id="newBoardSocketNum" class="form-control">
					</div>
				</div>	 -->
				<div class="form-group">
					<label class="control-label col-md-4">可插拔插槽列表:</label>
					<div class="col-md-5">
						<select name="newBoardSocketList" value="" id="newBoardSocketList" class="form-control" multiple="mutiple">
							<!--  <option value="1">SIC</option>
							<option value="2">MIM</option>-->
						</select>
					</div>
					<!--  <div class="col-md-3">
						<select name="newBoardSocketListNum" value="" id="newBoardSocketListNum" class="form-control">
							<option>1个</option>
							<option>2个</option>
							<option>3个</option>
						</select>
				...
				<div class="form-group">
					<label class="control-label col-md-4">备注:</label>
					<div class="col-md-8">
						<textarea type="text" name="newBoardDes" id="newBoardDes" class="form-control">
						</textarea> 
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-4">接口及插槽信息表:</label>
					<div class="col-md-8">
							<table id="portSlotInfo"  class="table table-striped table-bordered table-hover" style="text-align:center;width:500px">
								<thead class="thead-font">
									<tr>
										<th width="10%">序号</th>
										<th width="25%">接口/插槽类型</th>
										<th style="text-align:center">接口/插槽名字</th>
										<th width="25%" style="text-align:center">坐标</th>
										<th style="text-align:center">编辑</th>
									</tr>
								</thead>
								<tbody id="portSlotTbody" class="tbody-font">
				...
				<div class="form-group">
					<label class="control-label col-md-4"></label>
					<div style="text-align:center">
						<button type="button" class="btn btn-success"  id="addSubmit">确定</button>
					</div> 
				</div>				
			</form>
			<div class="hr hr-12 hr-double"></div>		
		...
		<script src="js/add/ad_board1.js"></script>
		<!-- 图片上传 -->
		<script src="js/upload/uploadPreview.js" type="text/javascript"></script>
