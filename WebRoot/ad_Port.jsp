...
<html lang="en-us">
	...
	<header id="header" style="height:100px;">
			<div id="logo-group" style="width:100%;">
				...
				<label class="TitleLabel">接口管理</label>
				<!-- END AJAX-DROPDOWN -->
			</div>
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark" style="font-family:'Microsoft YaHei';"><i class="fa fa-lg fa-fw fa-code-fork"></i> 接口管理 </h1>
					</div>
				...
				<div>
				<a class="btn btn-success btn-lg" href="javascript:void(0);" style="margin-bottom: 1%;float:right" id="addPort"><i class="fa fa-lg fa-fw fa-plus-circle"></i>添加接口</a>
				<!-- row -->
					<div class="row">
							...
							<div class="jarviswidget jarviswidget-color-darken" data-widget-editbutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<table id="portTable" class="table table-striped table-bordered table-hover"style="text-align:center">
											...
											<tbody id="portTable" class="tbody-font">	
												<!--  <tr>
													<td>1</td>
												    <td>接口1</td>
													<td>光口</td>
			...
			<form  class="form-horizontal" style="width:50%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei';margin-top:20px">
				<div class="form-group">
					<label class="control-label col-md-4">接口名称:</label>
					<div class=" col-md-8">
					<input name="portName" value="" id="portName" class="form-control">
					</div>
				</div>
				<!--  <div class="form-group">
					<label class="control-label col-md-4">接口类型:</label>
					<div class="col-md-5">
						<select name="PortType" value="" id="PortType" class="form-control">
							<option>光口</option>
							<option>以太电口</option>
							<option>E1口</option>
						</select>
				...
				<!--  <div class="form-group">
					<label class="control-label col-md-4">接口参数列表:</label>
					<div class="col-md-8">
						<select name="portList" value="" id="portList" class="form-control">
							<option>接口1</option>
							<option>接口2</option>
						</select>
					</div>
				...
				<div class="form-group">
					...
					<div class=" col-md-8">
					<textarea name="portDes" rows="5" id="portDes" class="form-control">
					</textarea>
					</div>
				</div>	
				<div class="form-group">
		...
		<div  class="page2 dialog-message">
			<form  class="form-horizontal" style="width:70%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei';margin-top:20px">
				<div class="form-group">
					...
					<div class=" col-md-10">
					<input name="newportName" value="" id="newportName" class="form-control">
					</div>
				</div>
				<!--  <div class="form-group">
					<label class="control-label col-md-2">接口编号:</label>
					<div class=" col-md-10">
					<input name="newportNum" value="" id="newportNum" class="form-control">
					</div>
				</div>-->
				<div class="form-group">
					<label class="control-label col-md-2">接口类型:</label>
					<div class=" col-md-10">
					<input name="newportType" value="" id="newportType" class="form-control">
					</div>
					<!--  <div class=" col-md-10">
					<select name="newportType" value="" id="newportType" class="form-control">
						<option>光口</option>
						<option>以太电口</option>
						<option>E1口</option>
					</select>
				...
				<div class="form-group">
					<label class="control-label col-md-2">接口参数:</label>
					<div class=" col-md-10">
						<button type="button" class="btn btn-success" id="newParameter">添加参数</button>
					<!--  <select name="newportList" value="" id="newportList" class="form-control">
						<option>参数列表</option>
						<option>接口1</option>
						<option>接口2</option>
					</select>-->
				...
				<div class="form-group">
					...
					<div class=" col-md-10">
					<textarea name="newportDes" rows="5" id="newportDes" class="form-control">
					</textarea>
					</div>
				</div>		
				<div class="form-group">
		...
		<script src="js/add/ad_port.js"></script>
