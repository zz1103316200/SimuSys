  ...
  <body onload="main(document.getElementById('graphContainer'),
	...
	<div id="main" role="main" style="font-family:'Microsoft YaHei'">
		...
		<div  class="page2 dialog-message">
			<form  class="form-horizontal" style="width:80%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei'">
				<div class="form-group">
					<label class="control-label col-md-2">机器评定成绩:</label>
					<div class=" col-md-10">
						<input name="FlowName" value="93" id="compGrade" class="form-control" readonly>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">人工评定成绩:</label>
					<div class=" col-md-10">
						<input name="FlowName" value="" id="humanGrade" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">评语:</label>
					<div class=" col-md-10" >
						<textarea class="form-control col-md-10" rows="5" id="gradeDescription"></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2"></label>
					<div class=" col-md-10">
						<button type="button" id="submitGrade" class="btn btn-success" >确定</button>
					</div> 
				</div>
		...
		<!-- <script type="text/javascript" src="./media/js/businessMain.js"
			charset="utf-8"></script> -->
		<script type="text/javascript" src="./media/js/businessMain1.js"
			charset="utf-8"></script>
		...
		<script src="./media/js/tea_showTask.js"></script>
		<script src="./media/js/zw.js"></script>
  </body>
</html>