...
<html lang="en-us">
	...
	<header id="header" style="height:100px;">
		...
		<div id="main" role="main">
			...
			<form  class="form-horizontal" style="width:60%;margin-left:20%;font-size:16px;font-family:'Microsoft YaHei'">
				<div class="form-group">
					...
					<div class=" col-md-10">
						<input name="courseName" value="" id="courseName" class="form-control" readonly>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">课程编号:</label>
					<div class=" col-md-10">
						<input name="courseName" value="" id="courseNum" class="form-control" readonly>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">班级:</label>
					<div class="col-md-10">
						<select name="newTeaTime" id="editClass" class="form-control">							
						<option value="selectable">任选课</option>	
						</select>			
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">授课老师:</label>
					<div class="col-md-10">
						<select name="newTeaTime" id="editTeacher" class="form-control">							
						<!-- <option value="selectable">任选课</option> -->	
						</select>			
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<textarea name="courseDes" value="" id="courseDes" class="form-control"></textarea>				
					</div>
				</div>
				<div class="form-group">
		...
		<div  class="page2 dialog-message">
			<form  class="form-horizontal" style="width:80%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei'">
				...
				<div class="form-group">
					<label class="control-label col-md-2">班级:</label>
					<div class="col-md-10">
						<select name="newTeaTime" id="newClass" class="form-control">							
						<option value="selectable">任选课</option>	
						</select>			
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">授课老师:</label>
					<div class="col-md-10">
						<select name="newTeaTime" id="newTeacher" class="form-control">							
						<!-- <option value="selectable">任选课</option> -->	
						</select>			
					</div>
				</div>
		...
		<script src="js/add/admin_Cour.js"></script>
