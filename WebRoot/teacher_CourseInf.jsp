...
<html lang="en-us">
	<head>
		...
		<!-- <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,700italic,300,400,700"> -->
         ...
         <style type="text/css">
         		#courseTable tr th,#courseTable tbody{
         			text-align: center;
         		}
         </style>
	<header id="header" style="height:100px;">
			<div id="logo-group" style="width:100%;">
				...
				<label class="TitleLabel">课程管理</label>
				<!-- END AJAX-DROPDOWN -->
			</div>
			...
			<div class="pull-right">
				...
				<ul class="header-dropdown-list hidden-xs" id="AdminInfo">
					<li>
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img alt="" src="img/avatar1.jpg"><span id="login_username"><%=name %></span><i class="fa fa-angle-down"></i> </a>
						<ul class="dropdown-menu pull-right">
							...
							<li>
								<a href="javascript:void(0);" style="font-family:  'Microsoft YaHei';"><i class="fa fa-key"></i>&nbsp;&nbsp;退出 </a>
							</li>
						</ul>
					</li>
				</ul>
		...
		<!-- User info -->
			...
			<nav>
				...
				<ul>
					<li>
						<a href="teacher_TaskManagement.jsp">
						<i class="fa fa-lg fa-fw fa-cloud-download"></i> 
						<span class="menu-item-parent" style="font-family:  'Microsoft YaHei';font-size:16px; " id="PageSerDeploy">作业管理</span>
						</a>
					</li>
					<li class="active">
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark" style="font-family:'Microsoft YaHei';"><i class="fa fa-lg fa-fw fa-code-fork"></i> 课程管理 </h1>
					</div>
				...
				<div>
				<a class="btn btn-success btn-lg" href="javascript:void(0);" style="margin-bottom: 1%;float:right" id="addCourse"><i class="fa fa-lg fa-fw fa-plus-circle"></i>添加课程</a>
				<!-- row -->
					<div class="row">
										...
										<div class="widget-body-toolbar">
											<div>
												<select class='input-sm' id='search-type' style='font-size:14px'>
													...
													<option value="periods">学时数</option>
													<!-- <option value="courseTeach">授课教师</option> -->
													<option value="classTime">授课时间</option>
													<!-- <option value="coursePeo">已选人数</option> -->
										...
										<table  id="courseTable" class="table table-striped table-bordered table-hover">
											<thead class="thead-font">
												<tr>
													...
													<th>授课时间</th>
													<th>备注</th>
													<th colspan="3" style="width:20%">编辑</th>
												</tr>
											</thead>
											<tbody  class="tbody-font">
												<tr>
													...
													<td>课程详细信息</td>
													<td>
														<a class='btn btn-primary deleteservice btn-sm' href="teacher_StudentInfo.jsp"><i class='fa fa-gear'></i>&nbsp;&nbsp;学生信息</a>
													</td>
			...
			<form  class="form-horizontal" style="width:60%;margin-left:20%;font-size:16px;font-family:'Microsoft YaHei'">
				<div class="form-group">
					...
					<div class=" col-md-10">
						<input name="courseName" value="" id="courseName" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">学时数:</label>
					<div class="col-md-10">
					<input name="courseTime" value="" id="courseTime" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">授课时间:</label>
					<div class="col-md-10">
						<select name="teaTime" value="" id="teaTime" class="form-control">	
						<option value="first">上学期</option>	
						<option value="sercond">下学期</option>	
						<option value="both">全年</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2" >授课教师:</label>
					<div class="col-md-10" id="newTea">
						<input type="checkbox" name="teacher" value="">刘西洋
						<input type="checkbox" name="teacher" value="" >鲍亮			
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">备注:</label>
					<div class="col-md-10">
						<textarea name="courseDes" value="" id="courseDes" class="form-control">	
						</textarea>				
					</div>
				</div>
				<div class="form-group">
		...
		<div  class="page2 dialog-message">
			<form  class="form-horizontal" style="width:80%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei'">
				<div class="form-group">
					<label class="control-label col-md-2">课程名称:</label>
					<div class=" col-md-10">
						<input name="newCourseName" value="" id="newCourseName" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">课程编号:</label>
					<div class=" col-md-10">
						<input name="newCourseNum" value="" id="newCourseNum" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">学时数:</label>
					<div class="col-md-10">
					<input name="newCourseTime" value="" id="newCourseTime" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">授课时间:</label>
					<div class="col-md-10">
						<select name="newTeaTime"id="newTeaTime" class="form-control">	
						<option value="first">上学期</option>	
				...
				<div class="form-group">
					<label class="control-label col-md-2">授课教师</label>
					<div class="col-md-10" id="Tea">
						<select name="newTeaTime" value="" id="newTea" class="form-control">	
						<option>刘西洋</option>	
						<option>高海昌</option>
						<option>鲍亮</option>		
						</select>		
						<input type="checkbox" name="newTeacher" value="">刘西洋
						<input type="checkbox" name="newTeacher" value="" >鲍亮	
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">备注:</label>
					<div class="col-md-10">
						<textarea name="NewCourseDes" id="NewCourseDes" class="form-control">	
						</textarea>				
					</div>
				</div>
				<div class="form-group">
		...
		<script src="js/add/tea_Cour.js"></script>
