...
<html lang="en-us">
	...
	<header id="header" style="height:100px;">
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark" style="font-family:'Microsoft YaHei';"><i class="fa fa-lg fa-fw fa-code-fork"></i> 线缆管理 </h1>
					</div>
				...
				<div>
				<a class="btn btn-success btn-lg" href="javascript:void(0);" style="margin-bottom: 1%;float:right" id="addLine"><i class="fa fa-lg fa-fw fa-plus-circle"></i>添加线缆</a>
				<!-- row -->
					<div class="row">
							...
							<div class="jarviswidget jarviswidget-color-darken" data-widget-editbutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										<div class="widget-body-toolbar">
											<div>
												<select class='input-sm' id='search-type' style='font-size:14px'>
													...
													<option value="cableStyle">线缆类型</option>
										...
										<table id="lineTable" class="table table-striped table-bordered table-hover"style="text-align:center">
											...
											<tbody id="lineTable" class="tbody-font">	
												<tr>
													<!--  <td>1</td>
												    <td>线缆1</td>
													<td>PJ-45</td>
													...
													<td>备注信息</td>
													<td>
														<a class='btn btn-primary deleteservice btn-sm' ><i class='fa fa-gear'></i>&nbsp;&nbsp;修改</a>
													</td>
			...
			<form  class="form-horizontal" style="width:50%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei';margin-top:20px">
				<div class="form-group">
					<label class="control-label col-md-4">线缆名称:</label>
					<div class=" col-md-8">
					<input name="lineName" value="" id="lineName" class="form-control">
					</div>
				</div>
				<!--  <div class="form-group">
					<label class="control-label col-md-4">线缆类型:</label>
					<div class="col-md-5">
						<select name="lineType" value="" id="lineType" class="form-control">
							<option>PJ-45</option>
							<option>RJ-11</option>
							<option>E1接口线缆</option>
						</select>
					</div>
				</div>-->
				<!--  <div class="form-group">
					<label class="control-label col-md-4">线缆接头数量:</label>
					<div class=" col-md-8">
					<input name="lineName" value="" id="lineName" class="form-control">
					</div>
				</div>-->
				<!--  <div class="form-group">
					<label class="control-label col-md-4">线缆接头类型及数量:</label>
					<div class="col-md-5">
						<select name="lineList" value="" id="lineList" class="form-control" multiple="multiple">
							<option value="0">接头1</option>
							<option value="1">接头2</option>
						</select>
					</div>
					<div class="col-md-3">
						<select name="lineListNum" value="" id="lineListNum" class="form-control">
				...
				<div class="form-group">
					...
					<div class=" col-md-8">
					<textarea name="lineDes" value="" id="lineDes" class="form-control">
					</textarea>
					</div>
				</div>	
				<div class="form-group">
		...
		<div  class="page2 dialog-message">
			<form action="servlet/UpLoadify"  method="post"  enctype="multipart/form-data" target="hidden_frame"  class="form-horizontal" style="width:70%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei'">				
				<div class="form-group">
					<label class="control-label col-md-2">线缆名称:</label>
					<div class=" col-md-8">
					<input name="newLineName" value="" id="newLineName" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">线缆类型:</label>
					<div class="col-md-8">
						<input name="newLineType" value="" id="newLineType" class="form-control">
						<!--  <select name="newLineType" value="" id="newLineType" class="form-control">
							<option>PJ-45</option>
							<option>RJ-11</option>
							<option>E1接口线缆</option>
						</select>-->
				...
				<div class="form-group">
					<label class="control-label col-md-2">线缆侧栏图片:</label>
					<div class="col-md-8">
				        <div id="img_div">
				...
				<div class="form-group">
					<label class="control-label col-md-2">线缆接头:</label>
					 <div class=" col-md-10">
					    <button type="button" class="btn btn-success" id="newConnA">添加A端接头</button>
						<button type="button" class="btn btn-success" id="newConnB" style="margin-left:20px">添加B端接头</button>
						
					</div>
				</div>
				<div class="ConnContentA"></div>
				<div class="ConnContentB"></div>
				<!-- <div class="form-group">
					<label class="control-label col-md-4">线缆接头类型及数量:</label>
					<div class="col-md-5">
						<select name="newLineList" value="" id="newLineList" class="form-control" multiple="multiple">
							<option value="0">接头1</option>
							<option value="1">接头2</option>
							<option value="2">接头3</option>
							<option value="3">接头4</option>
							<option value="4">接头5</option>
							<option value="5">接头6</option>
						</select>
					</div>
					<div class="col-md-3">
						<select name="newLineListNum" value="" id="newLineListNum" class="form-control">
							<option value="0">1个</option>
							<option value="1">2个</option>
							<option value="2">3个</option>
							<option value="3">4个</option>
							<option value="4">5个</option>
							<option value="5">6个</option>
						</select>
					</div>
				</div>	 -->
				<div class="form-group">
					<label class="control-label col-md-2">线缆样式:</label>
					<div class=" col-md-8">
					<input name="mycolor" value="" id="mycolor" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">备注:</label>
					<div class=" col-md-8">
					<textarea name="newLineDes" value="" id="newLineDes" class="form-control"></textarea>
					</div>
				</div>
		...
		<script src="js/add/ad_line.js"></script>
		<!-- 图片上传 -->
        ...
        <!-- 颜色选择器 -->
        <script src="js/plugin/evol.colorpicker.min.js"></script>
