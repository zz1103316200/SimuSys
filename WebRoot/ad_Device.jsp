...
<html lang="en-us">
	...
	<header id="header" style="height:100px;">
			<div id="logo-group" style="width:100%;">
				...
				<label class="TitleLabel">设备管理</label>
				<!-- END AJAX-DROPDOWN -->
			</div>
		...
		<!-- User info -->
			...
			<nav>
				...
				<ul>
					...
					<!-- <li>
						<a href="admin_StudentManagement.jsp" title="Dashboard">
						<i class="fa fa-lg fa-fw fa-gear"></i> 
					...
					<li>
						...
						<ul>
							...
							<!--  <li>
								<a href="ad_Module.jsp" style="font-family:  'Microsoft YaHei';font-size:16px; ">模块管理</a>
							</li>-->
							<li>
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark" style="font-family:'Microsoft YaHei';"><i class="fa fa-lg fa-fw fa-code-fork"></i> 设备管理 </h1>
					</div>
				...
				<div>
				<a class="btn btn-success btn-lg" href="javascript:void(0);" style="margin-bottom: 1%;float:right" id="addDevice"><i class="fa fa-lg fa-fw fa-plus-circle"></i>添加设备</a>
				<!-- row -->
					<div class="row">
							...
							<div class="jarviswidget jarviswidget-color-darken" data-widget-editbutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<table id="deviceTable" class="table table-striped table-bordered table-hover"style="text-align:center">
			...
			<form  class="form-horizontal" style="width:40%;margin-left:20%;font-size:16px;font-family:'Microsoft YaHei';margin-top:20px">
				<div class="form-group">
					<label class="control-label col-md-4">设备名称:</label>
					<div class=" col-md-8">
						<input name="deviceName" value="" id="deviceName" class="form-control">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<select name="deviceType" value="" id="deviceType" class="form-control">
							<!-- <option>路由器</option>
							<option>交换机</option>
							<option>光端机</option> -->
						</select>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input name="deviceDes" value="" id="deviceDes" class="form-control">
					</div>
				</div>	
				<!-- <div class="form-group">
					<label class="control-label col-md-4">固定接口数量:</label>
					<div class="col-md-8">
						<input name="fixedNum" id="fixedNum" type="text" class="form-control">
					</div>
				</div> -->
				 <!-- 
				<div class="form-group">
					...
					<div class="col-md-5">
						<select name="fixList" value="" id="fixList" class="form-control" multiple="mutiple">
						
						</select>
					</div>
					<div class="col-md-3">
					<select name="fixListNum" value="" id="fixListNum" class="form-control">
							<option>1个</option>
							<option>2个</option>
							<option>3个</option>
					</select>
				...
				<div class="form-group">
					<label class="control-label col-md-4">可插拔插卡槽列表:</label>
					<div class="col-md-5">
						<select name="socketList" value="" id="socketList" class="form-control" multiple="mutiple">
							
						</select>
					</div>
					<div class="col-md-3">
						<select name="socketListNum" value="" id="socketListNum" class="form-control">
							<option>1个</option>
							<option>2个</option>
							<option>3个</option>
						</select>
		...
		<div  class="page2 dialog-message">
			<form action="./servlet/UpLoadify" method="post"  enctype="multipart/form-data" target="hidden_frame"  class="form-horizontal" style="width:40%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei'">				
				<div class="form-group">
					<label class="control-label col-md-4">设备名称:</label>
					<div class=" col-md-8">
						<input name="newDeviceName" value="" id="newDeviceName" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-4">设备编号:</label>
					<div class=" col-md-8">
						<input name="newDeviceNum" value="" id="newDeviceNum" class="form-control">
					</div>
				</div>
				...
				<div class="form-group">
					<label class="control-label col-md-4">设备类型:</label>
					<div class="col-md-8">
						<select name="newDeviceType" value="" id="newDeviceType" class="form-control">
							<!--  <option>路由器</option>
							<option>交换机</option>
							<option>光端机</option>-->
						</select>
				...
				<div class="form-group">
					<label class="control-label col-md-4">设备描述:</label>
					<div class="col-md-8">
						<input name="newDeviceDes" value="" id="newDeviceDes" class="form-control">
					</div>
				</div>	
				
				<div class="form-group">
					<label class="control-label col-md-4">设备侧栏图片:</label>
					<div class="col-md-8">
				        <div id="img_div">
							<img id="img_show" width="70" height="70"/>
						</div>
				        <input type="file" name="file" size="50" id="img_up"/>
                     	<br />
				...
				<div class="form-group">
					<label class="control-label col-md-4">设备实际图片:</label>
					<div class="col-md-8">
						<div id="imgdiv" style="height:80px;">
							<img id="imgShow" width="500" height="80" style="float:left"/>
						</div>
				...
				<div class="form-group">
					<label class="control-label col-md-4">固定接口列表:</label>
					<div class="col-md-5">
						<select name="newFixList" value="" id="newFixList" class="form-control" multiple="mutiple">
				...
				<div class="form-group">
					<label class="control-label col-md-4">可插拔插卡槽列表:</label>
					<div class="col-md-5">
						<select name="newSocketList" value="" id="newSocketList" class="form-control" multiple="mutiple">
				...
				<div class="form-group">
					...
					<!--  	<button type="button" class="btn btn-success"  id="addSubmit">确定</button>-->
						<input id="addSubmit" type="submit" class="btn btn-success" value="确定" />
					</div> 
				</div>		
			</form>
			<div class="hr hr-12 hr-double"></div>		
		...
		<script src="js/add/ad_device1.js"></script>
		<!-- 图片上传 -->
