	...
	text-align:center;
		...
		<header id="header" style="height:100px;">
			<div id="logo-group" style="width:100%;">
				...
				<label class="TitleLabel">学员管理</label>
				<!-- END AJAX-DROPDOWN -->
			</div>
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark" style="font-family:'Microsoft YaHei';"><i class="fa fa-lg fa-fw fa-code-fork"></i> 学员管理 </h1>
					</div>
				...
				<div>
				<a class="btn btn-success btn-lg" href="javascript:void(0);" style="margin-bottom: 1%;float:right" id="addStu"><i class="fa fa-lg fa-fw fa-plus-circle"></i>添加学员信息</a>
				<!-- row -->
					<div class="row">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-4" data-widget-editbutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										<div class="widget-body-toolbar">
											<div>
												<select class='input-sm' id='search-type' style='font-size:14px'>
													...
													<!-- <option value='course'>所学课程</option> -->
													<option value='major'>专业</option>
												</select >
												<span class="filtertype"><!-- <input type='text' class='input-sm'/> --></span>
										...
										<table  class="table table-striped table-bordered table-hover" style="text-align:center" id="stuTable" >
											<thead class="thead-font">
												<tr>
													...
													<th>专业</th>
													<th>备注</th>
													<th colspan="2" style="width:20%">编辑</th>
												</tr>
											</thead>
			...
			<div class="form-group">
					...
					<div class=" col-md-10">
						<input name="stuname" value="" id="stuname" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">年龄:</label>
					<div class=" col-md-10">
						<input name="stuage" value="" id="stuage" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">性别:</label>
					<div class=" col-md-10">
						<input type="radio" name="stusex" value="male" >男
				...
				<!-- <div class="form-group">
					<label class="control-label col-md-2">所学课程:</label>
					<div class="col-md-10" id="stucourse">
						<input type="checkbox" name="course" value="">java
						<input type="checkbox" name="course" value="">c++
						<input type="checkbox" name="course" value="">c
						<input type="checkbox" name="course" value="">c#
						<input type="checkbox" name="course" value="">计算机网络
					</div>
				</div> -->
				<div class="form-group">
					<label class="control-label col-md-2">专业:</label>
					<div class="col-md-10">
						<select name="stupro" id="stupro" class="form-control">
						</select>
					</div>
				</div>	
				<div class="form-group">
					...
					<div class="col-md-10">
						<input name="studes" value="" id="studes" class="form-control">
		...
		<div  class="page2 dialog-message" >
			<form  class="form-horizontal" style="width:80%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei'">
				<div class="form-group">
					<label class="control-label col-md-2">姓名:</label>
					<div class=" col-md-10">
						<input name="newComStuName" value="" id="newComStuName" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">学号:</label>
					<div class=" col-md-10">
						<input name="newCompStuName" value="" id="newCompStuNum" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">年龄:</label>
					<div class=" col-md-10">
						<input name="newCompStuAge" value="" id="newCompStuAge" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">性别:</label>
					<div class=" col-md-10">
						<input type="radio" name="newstusex" value="male" >男
						<input type="radio" name="newstusex" value="female">女
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">班级:</label>
					<div class="col-md-10">
						<select name="newCompStuClass" id="newCompStuClass" class="form-control">
						</select>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">专业:</label>
					<div class=" col-md-10">
					<select name="newCompStuPro" id="newCompStuPro" class="form-control">
					</select>
					</div>
				</div>
				<!-- <div class="form-group">
				...
				<div class="form-group">
					<label class="control-label col-md-2">备注:</label>
					<div class=" col-md-10">
						<textarea class="form-control col-md-10" rows="5" name="newCompStuDes" id="newCompStuDes"></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2"></label>
					<div class=" col-md-10">
						<button type="button" class="btn btn-success"  id="stuOk" >提交</button>
					</div> 
				</div>
		...
		<script src="js/add/admin_Stu.js"></script>
