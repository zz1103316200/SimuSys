	...
	<header id="header" style="height:100px;">
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div>
				<a class="btn btn-success btn-lg" href="javascript:void(0);" style="margin-bottom: 1%;float:right" id="AddComp"><i class="fa fa-lg fa-fw fa-plus-circle"></i>添加作业</a>
				<!-- row -->
					<div class="row">
		...
		<script src="js/add/tea_TaskFenpei.js"></script> 
