	...
	<header id="header" style="height:100px;">
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div>
				<a class="btn btn-success btn-lg" href="javascript:void(0);" style="margin-bottom: 1%;float:right" id="AddComp"><i class="fa fa-lg fa-fw fa-plus-circle"></i>确认</a>
				<!-- row -->
					<div class="row">
											...
											<div>
												<select class='input-sm' id='search-type' style='font-size:14px'>
													<option value=''>请选择搜索的类型</option>
													 ...
													 <option value='taskState'>作业状态</option>
												...
												<tr>
													...
													<td class="col-sm-1 col-md-1 col-lg-1">
														<!-- <div class="dd" id="nestable2">
															...
															<input class="form-control"  id="spinner" name="spinner" value="1" type="text">
														
													</td>
													
												    <td><label class="checkbox state-error"><input type="checkbox" name="checkbox"><i></i></label></td>
		...
		<script src="js/plugin/jquery-nestable/jquery.nestable.js"></script>
		<script src="js/add/tea_TaskDevice.js"></script>
