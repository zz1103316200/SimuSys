  ...
  <head>
	...
	<header id="header" style="height:100px;">
			<div id="logo-group" style="width:100%;">
				...
				<label class="TitleLabel">班级管理</label>
				<!-- END AJAX-DROPDOWN -->
			</div>
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark" style="font-family:'Microsoft YaHei';"><i class="fa fa-lg fa-fw fa-code-fork"></i> 班级管理 </h1>
					</div>
				...
				<div>
				<a class="btn btn-success btn-lg" href="javascript:void(0);" style="margin-bottom: 1%;float:right" id="addClass"><i class="fa fa-lg fa-fw fa-plus-circle"></i>添加班级信息</a>
				<!-- row -->
					<div class="row">
							...
							<div class="jarviswidget jarviswidget-color-darken" data-widget-editbutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										<div class="widget-body-toolbar">
											<div>
												<select class='input-sm' id='search-type' style='font-size:14px'>
													...
													<option value='classNum'>班级编号</option>
													<option value='startTime'>入学时间</option>
													<!-- <option value='major'>专业</option> -->
													<option value='level'>层次</option>
												</select >
										...
										<table id="classTable" class="table table-striped table-bordered table-hover"style="text-align:center">
											...
											<tbody class="tbody-font">
												<tr>
													...
													<td>备注信息</td>
													<td>
														<a class='btn btn-primary btn-sm' onclick='edit(0)'><i class='fa fa-gear'></i>&nbsp;&nbsp;修改</a>
													</td>
													<td><a class='btn btn-danger deleteservice btn-sm' ><i class='fa fa-times-circle'></i>&nbsp;&nbsp;删除</a>
													</td>
												</tr>					
											</tbody>
										</table>
			...
			<form  class="form-horizontal"  style="width:60%;margin-left:15%;font-size:16px;font-family:'Microsoft YaHei'">
				<div class="form-group">
					<label class="control-label col-md-4">班级名称:</label>
					<div class=" col-md-8">
						<input name="CompName" value="" id="compname" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-4">专业:</label>
					<div class="col-md-8">
						<input name="comppro"  id="comppro" class="form-control">
						
					</div>
				</div>	
				<div class="form-group">
					<label class="control-label col-md-4">入学时间:</label>
					<div class="col-md-8">
						<select name="comptime" value="" id="comptime" class="form-control">
						</select>
					</div>
				</div>	
				<div class="form-group">
					<label class="control-label col-md-4">层次:</label>
					<div class="col-md-8">
						<select name="complevel" value="" id="complevel" class="form-control">
							<option>硕士研究生</option>
							<option>本科</option>
							<option>专科</option>
							<option>4+1</option>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<textarea name="comptext" value="" id="comptext" class="form-control">
						</textarea> 
					</div>
				</div>					
				<div class="form-group">
		...
		<div  class="page2 dialog-message">
			<form  class="form-horizontal" style="width:80%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei'">				
				<div class="form-group">
					...
					<div class=" col-md-8">
						<input name="newCompClassName" value="" id="newCompClassName" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">班级编号:</label>
					<div class=" col-md-8">
						<input name="newCompClassNum" value="" id="newCompClassNum" class="form-control" onclick="checkForm()">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">专业:</label>
					<div class="col-md-8">
						<input name="newCompClassPro" id="newCompClassPro" class="form-control">
						
					</div>
				</div>	
				<div class="form-group">
					<label class="control-label col-md-3">层次:</label>
					<div class="col-md-8">
						<select name="newCompClassLevel"id="newCompClassLevel" class="form-control">
				...
				<div class="form-group">
					<label class="control-label col-md-3">入学时间:</label>
					<div class="col-md-8">
						<select name="newCompClassTime"  id="newCompClassTime" class="form-control">
						<!-- <option>2014</option> -->
						</select>
					</div>
				</div>	
				<div class="form-group">
					...
					<div class="col-md-8">
						<textarea name="newCompClassText"  id="newCompClassText" class="form-control">
						</textarea> 
					</div>
				</div>					
				<div class="form-group">
					...
					<div class=" col-md-8">
						<button type="button" class="btn btn-success"  id="addClassOk" >提交</button>
					</div> 
				</div>				
			</form>
			<div class="hr hr-12 hr-double"></div>		
		...
		<div class="page3 dialog-message">
			<form  class="form-horizontal" style="width:40%;margin-left:20%;font-size:16px;font-family:'Microsoft YaHei'">
				<div class="form-group">
					...
					<div class=" col-md-9">
						<input name="adminOldPass" value="" id="adminOldPass" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">新密码：</label>
					<div class=" col-md-9">
						<input name="adminNewPass" value="" id="adminNewPass" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">确认密码：</label>
					<div class=" col-md-9">
						<input name="readminPass" value="" id="readminPass" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3"></label>
					<div class=" col-md-9">
						<button type="button" class="btn btn-success"  id="ok" >提交</button>
					</div> 
				</div>
			</form>
			<div class="hr hr-12 hr-double"></div>
		...
		<script src="js/add/admin_Adclass.js"></script>
</html>
