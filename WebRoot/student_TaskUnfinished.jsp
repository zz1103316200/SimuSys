	...
	<header id="header" style="height:100px;">
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div>
				<!-- <a class="btn btn-success btn-lg" href="./graph/student_DealTask.jsp" style="margin-bottom: 1%;float:right"><i class="fa fa-lg fa-fw fa-plus-circle"></i>自定义作业</a>  -->
				<!-- row -->
					<div class="row">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-4" data-widget-editbutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<table id="stutaskUn" class="table table-striped table-bordered table-hover">
											...
											<tbody id="Comptable" class="tbody-font">
												...
												<!--  <tr>
													...
													<td>
														...
														<a href="./graph/student_DealTask.html" class='btn btn-primary deleteservice btn-sm' ><i class='fa fa-gear'></i>&nbsp;&nbsp;处理</a>
													</td>
		...
		<div  class="page2 dialog-message">
			<form  class="form-horizontal" style="width:80%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei'">
				<div class="form-group">
					<label class="control-label col-md-2">作业ID:</label>
					<div class=" col-md-10">
						<input name="CompName" value="" id="newCompName" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">描述:</label>
				...
				<div class="form-group">
					<label class="control-label col-md-2"></label>
					<div class=" col-md-10">
						<button type="button" class="btn btn-success"  id="addComp" onClick="fileupload()">提交</button>
					</div> 
				</div>
		...
		<script src="js/add/stu_TaskUnfinished.js"></script>
