	...
	<header id="header" style="height:100px;">
		...
		<div id="main" role="main">
			...
			<div id="content">
				...
				<div>
				<a class="btn btn-success btn-lg" href="javascript:void(0);" style="margin-bottom: 1%;float:right" id="AddComp"><i class="fa fa-lg fa-fw fa-plus-circle"></i>设置</a> 
				<!-- row -->
					<div class="row">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-4" data-widget-editbutton="false">
								...
								<div>
									...
									<div class="widget-body no-padding">
										<div class="widget-body-toolbar">
											<div>
												<select class='input-sm' id='search-type' style='font-size:14px'>
													...
													<option value='gradeState'>成绩状态</option>
										...
										<table id="teaResult" class="table table-striped table-bordered table-hover">
											...
											<tbody id="Comptable" class="tbody-font">
												...
												<tr>
													...
													<td>
														...
														<a href="./graph/teacher_ShowTask.jsp" class='btn btn-primary deleteservice btn-sm' ><i class='fa fa-gear'></i>&nbsp;&nbsp;查看</a>
													</td>
			...
			<form  class="form-horizontal" style="width:60%;margin-left:20%;font-size:16px;font-family:'Microsoft YaHei'">
				<div class="form-group">
					<label class="control-label col-md-2">作业ID:</label>
					<div class=" col-md-10">
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<input name="CompName" value="" id="compdes" class="form-control">
						
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-2">作业详细:</label>
					<div class="col-md-10">
						<input name="CompName" value="" id="compdes" class="form-control">
		...
		<div  class="page2 dialog-message">
			<form  class="form-horizontal" style="width:80%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei'">
				<div class="form-group">
					<label class="control-label col-md-2">机器成绩比重(%):</label>
					<div class=" col-md-6">
						<input name="CompName" value="" id="newWeight" class="form-control">
					</div>
					<lable class="col-md-2">(0~100)</lable>
					<lable id="gradewarnning" class="col-md-2" style="color:red;"></lable>
				</div>			
				
				<div class="form-group">
					<label class="control-label col-md-2"></label>
					<div class=" col-md-10">
						<button type="button" class="btn btn-success"  id="addComp_submit" >确定</button>
					</div> 
				</div>
		...
		<script src="js/add/tea_Result.js"></script>
