	...
	<header id="header" style="height:100px;">
		...
		<div id="main" role="main">
										...
										<div class="widget-body-toolbar">
											<div>
												<select class='input-sm' id='search-type' style='font-size:14px'>
													...
													<option value='TeacherName'>授课教师</option>
			...
			<form  class="form-horizontal" style="width:40%;margin-left:20%;font-size:16px;font-family:'Microsoft YaHei';margin-top:20px">
				...
				<div class="form-group">
					<label class="control-label col-md-4">课程性质:</label>
					<div class="col-md-8">
						<select name="complevel" id="comppro" class="form-control">
						</select>
					</div>
				</div>	
				<div class="form-group">
					<label class="control-label col-md-4">授课老师:</label>
					<div class="col-md-8">
						<select name="comppro" id="compteacher" class="form-control">
						</select>
					</div>
				</div>	
				<div class="form-group">
					...
					<div class="col-md-8">
						<select name="comppro" id="compcourse" class="form-control">
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-8">
						<select name="comptime"  id="comptime" class="form-control">
						</select>
					</div>
				</div>	
				<!-- <div class="form-group">
					...
					<div class="col-md-8">
						<select name="complevel" id="complevel" class="form-control">
							<option>硕士研究生</option>
							<option>本科</option>
							<option>专科</option>
							<option>4+1</option>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<textarea name="comptext" id="comptext" class="form-control">
						</textarea> 
					</div>
				</div>					
				<div class="form-group">
		...
		<div  class="page2 dialog-message">
			<form  class="form-horizontal" style="width:80%;margin-left:10%;font-size:16px;font-family:'Microsoft YaHei'">				
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input name="newCompClassId" value="" id="newCompClassId" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3">课程性质:</label>
					<div class="col-md-8">
						<select name="newPro" value="" id="newPro" class="form-control">
							<option >选修</option>
							<option>1303121</option>
							<option>1303122</option>
							<option>1303123</option>
						</select>
					</div>
				</div>	
				<div class="form-group">
					<label class="control-label col-md-3">授课老师:</label>
					<div class="col-md-8">
					<select id="newCompTea" class="form-control">
					</select>
					</div>
				</div>	
				<div class="form-group">
					...
					<div class="col-md-8">
						<select name="comppro" value="" id="newCompCourse" class="form-control">
						</select>
					</div>
				</div>
				<!-- <div class="form-group">
					...
					<div class="col-md-8">
						<select name="newCompClasslevel" value="" id="newCompClasslevel" class="form-control">
							<option>硕士研究生</option>
							<option>本科</option>
							<option>专科</option>
							<option>4+1</option>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<textarea name="newCompClassText" value="" id="newCompClassText" class="form-control">
						</textarea> 
					</div>
				</div>					
				<div class="form-group">
		...
		<script src="js/plugin/datatables/DT_bootstrap.js"></script>
		 <script src="js/add/admin_Logclass.js"></script>
</html>
