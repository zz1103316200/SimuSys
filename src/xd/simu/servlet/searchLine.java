...
public class searchLine extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int length = 0;
		if(searchLevel=="all"||searchLevel.equals("all"))
		{
			Object []obj={page,pagenum};
			cableList=cabletable.select(obj);
			length = cabletable.selectCount(obj);
		}
		else if(searchLevel=="cableName"||searchLevel.equals("cableName"))
		{
			String searchvalue=request.getParameter("key");
			Object []obj={searchvalue,page,pagenum};
			cableList=cabletable.selectByCableName(obj);
			length = cabletable.selectCountByCableName(obj);
		}
		else if(searchLevel=="cableStyle"||searchLevel.equals("cableStyle"))
		{
			String searchvalue=request.getParameter("key");
			System.out.println("searchvalue:"+searchvalue);
			Object []obj={searchvalue,page,pagenum};
			cableList=cabletable.selectByCableStyle(obj);
			length = cabletable.selectCountByCableStyle(obj);
		}
