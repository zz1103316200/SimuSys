...
public class searchPort extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int length = 0;
		 ...
		 //班级名称
		 else if(search_type=="interfaceID"||search_type.equals("interfaceID"))
		 {
			 String searchvalue=request.getParameter("key");
			
			 Object []obj={searchvalue,page,pagenum};
			 interfaceList=interfacetable.selectByinterfaceID(obj);
