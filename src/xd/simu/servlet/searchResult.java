...
public class searchResult extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		TaskVo tv = null;
		String gradeState="";
		if(searchvalue.equals("unFinished")){
			gradeState="false";
		}else if(searchvalue.equals("allFinished")){
			gradeState="true";
		}
		//System.out.print(start+"--"+page);
		TaskSubmitDao classtable=new TaskSubmitDao();
		StudentDao sd = new StudentDao();
		List<TaskSubmitVo> classtableList=new ArrayList<TaskSubmitVo>();
		...
		search_type=search_type.trim();
		 ...
		 //ç­çº§åç§°
		 else if(search_type=="gradeState"||search_type.equals("gradeState"))
		 {

			 classtableList=classtable.selectByState(taskId,gradeState);
		}
